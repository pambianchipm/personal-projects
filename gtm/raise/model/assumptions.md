...
| A23 | Transcription cost (own-media scenario) | ≤$0.05/min STRESS CEILING (A5's named exclusion, still unpriced in the live model) | PROJECTED — invented ceiling; no vendor chosen, no page read. Chosen so the line is priced (chief m5: three lines) at a level generous to no vendor; closing receipt = vendor choice + raw snapshot at feasibility-spike time |
