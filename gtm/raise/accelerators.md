...
this cycle — see backlog DEADLINES and inbox 31 Aug).
LAW 3 NOTE: this file ends at a recommendation. Applying anywhere is Phin's
click.

**First breath (frame-of-reference rule):** this is the Raise lane's live
application calendar — which accelerators Player 2 (an AI marketing employee
for small businesses) can actually apply to this cycle, with sourced dates.

---

## Open now — the two real deadlines
...
- **Deadline: Nov 18, 2026** (window opened Aug 24, 2026) · program starts
...
- **Window: rolling intake** ("applications are reviewed on an ongoing
  basis" — no fixed US cohort dates). Sources: antler.co/location/us +
  antler.co/cohort-start-dates, both read 31 Aug 2026.
- **Terms as published: "$500K–$1M plus $650K in partner credits"** initial
  commitment. NOTE: Antler's model is a residency that typically invests
  post-validation at its own gate, not a fixed day-one check like ERA/
...
- **Recommendation: HOLD** — pursue only after ERA/Techstars applications
  are in; rolling intake means it costs nothing to sequence it last.

## Watchlist (from shift 1, unchanged)

- **NYU EFL 2027-28** — projected to open ~May 2027 (PROJECTED, not
  sourced). Watch the program page.
...
in early-to-mid November. Item 4 (deck skeleton) and the raise-framing
answer (inbox bootstrap decision 2) stop being "when we get to it" and
acquire a working back-stop of ~1 Oct. This is the calendar Lane A did not
have.

## Honest floor

- Three programs researched to primary source this shift; this is not an
  exhaustive NYC scan (Betaworks Camp, Forum Ventures, Primary's programs,
  et al. unresearched — add on request, but the two November deadlines above
  are the actionable clock either way).
- All terms are as published today; term sheets at offer time govern.
- No assessment here is a demand-side signal: acceptance odds are unknowable
  from public pages and none are claimed.
