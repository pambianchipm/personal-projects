...
|---|---|---|
| **A. "AI marketing platform"** | The folder that already exists in buyers' heads; zero explanation needed | Crowded folder; anchors price to the ~$12–48/mo tool band (Holo's position — `competitor-holo.md` pricing table; third-party-sourced, spot-check before any external use). $299 reads 6× too expensive in this folder |
