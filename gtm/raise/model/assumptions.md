...
| A29 | BUY-EDITOR category price band | ~$0–29/mo for the named tools where a price is established (A25–A27); the band excludes Vizard (A28) and is a band over FOUR vendors, never a market-wide claim | DERIVED — A25/A26/A27 only, with A27's staleness inherited. Not a market size, not a top-down figure (law 2) |
