...
and advisors "capture ideas (separately) and then share." Your unanchored
answers are half the raw material; if you read the boss's capture first,
the merge loses its value. **Don't open `gtm/market/ksp-funnel.md` until
your answers are written down.**

**Format:** bullets, under 10 words each (deck rule). Gut over polish —
duplicates with the boss's list are GOOD (they're votes). Aim for 2–4
bullets per prompt, ~15 minutes total. Write answers inline below, or
paste them in chat to the chief / into the inbox — whatever is fastest.

---

## The five prompts (verbatim, deck p23)
...
**What happens with this:** your bullets + the boss's capture merge into
one list → cluster to 7–10 candidates → the coded concept cards (backlog
item 5) test the survivors with real owners → final 3–5 KSPs. Your
answers here are input to research, not claims — nothing you write ships
anywhere without the usual gates.
