# Founding-pilot terms letter — DRAFT for Phin's review
...
nothing roadmap is promised as present.

---

Subject: An honest proposal — free marketing help while we learn from you
...
it earns it — permission to name you as our first shop. You can say no
...
## Notes for Phin (not part of the letter)

- Bracketed fields are yours: name, pilot length, credit shape (D6),
  phone.
- The wind-down/export sentence is the D4 commitment made customer-
  facing — the same sentence can seed the `/continuity` page.
- "Runs in production today on my own product" is the dogfooding
  disclosure the deck gate required — kept honest here too.
- The letter deliberately does NOT promise: Monday emails, texting it,
  bookings attribution, market-watching — all roadmap or unclaimed. The
  interview kit's roadmap ledger applies if they ask.
- Law 1: their reactions during the pilot are the org's first
  longitudinal real-owner evidence; capture like interview notes.
